...
export function AvatarPicker() {
  ...
  return (
    ...
    <div className="flex items-center justify-center w-full ">
      <Button className="bg-transparent border-none ring-none" onClick={prev}>
      ...
      <Button onClick={prev} className="bg-transparent border-none ring-none">
    ...
    <div className="flex h-[50px] w-[250px] bg-primary rounded-md border-black border-[4px] px-3 py-2 text-sm ring-offset-background relative items-center" >
    ...
    <Button className="w-[500px] h-[100px] rounded-xl italic ring-8 ring-orange-600 ring-offset-3 ring-offset-black hover:bg-[#f7d726] text-[64px] flex items-center justify-center " onClick={onStart} >
